# This dockerfile uses extends image https://hub.docker.com/woodpecker-kit/woodpecker-file-browser-upload
# VERSION 1
...
ARG GO_ENV_PACKAGE_NAME=github.com/woodpecker-kit/woodpecker-file-browser-upload
ARG GO_ENV_ROOT_BUILD_BIN_NAME=woodpecker-file-browser-upload
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-file-browser-upload/main.go
...
ENTRYPOINT [ "/app/woodpecker-file-browser-upload" ]
# CMD ["/app/woodpecker-file-browser-upload", "--help"]
